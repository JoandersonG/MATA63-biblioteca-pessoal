...
public class BibliotecaTelaPrincipalAdministrador extends JFrame {
 ...
 */
    public static void main(String[] args) {
            EventQueue.invokeLater(new Runnable() {
                    public void run() {
                            try {
                                    BibliotecaTelaPrincipalAdministrador frame = new BibliotecaTelaPrincipalAdministrador();
     ...
     * Create the frame.
     */
    public BibliotecaTelaPrincipalAdministrador() {
            ...
            btnCadastrarUsuario.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent arg0) {
                            new CadastroTelaPrincipal().setVisible(true);
                    }
            });
