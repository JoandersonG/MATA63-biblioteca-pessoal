...
public class MostrarInformacoesLivroJFrame extends JFrame {
    ...
    private void criarFormulario(Livro livro) {
        ...
        setTitle("Persibi - Informa��es do livro buscado");
	...
	contentPane.setLayout(null);
        ...
        JLabel titulo = new JLabel ("Informa��es do livro buscado");
        ...
        final JTextArea isbnLabel = new JTextArea("C�digo ISBN : "); 
        ...
        final JTextArea codBarraLabel = new JTextArea("C�digo de barras : "); 
        ...
        final JTextArea generoLabel = new JTextArea("G�nero : "); 
